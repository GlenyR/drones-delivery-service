...
namespace DroneApp.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IDroneDeliveryService, DroneDeliveryService>();
            services.AddSingleton<IDeliveryService, DeliveryService>();
            services.AddSingleton<IInstructionService, InstructionService>();
            services.AddSingleton<ILocationPackagesService, LocationPackagesService>();
        }
